...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td colspan="2" style="cursor:pointer;font-size:1.4rem">'.$item->url.'</td><td style="cursor:pointer;font-size:1.4rem">www.'.$item->url.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="211" style="display:table-row;vertical-align:top"><td colspan="2">'.$item->http_code.'</td><td>'.$item->http_code_www.'</td></tr>';
	//$html_text .= '<tr id="212" style="display:table-row;vertical-align:top"><td colspan="2">'.$item->http_code_target.'</td><td>'.$item->http_code_target_www.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
