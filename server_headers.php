...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="111" style="display:table-row;font-style:italic"><td colspan="2">An apex domain is a root domain that does not contain a subdomain part.</td><td>The www subdomain has been considered unnecessary. There are some useful aspects.</td></tr>';
	$html_text .= '<tr id="112" style="display:table-row;font-style:italic"><td colspan="2">CNAME redirection is not allowed from the root domain.</td><td>If you host elsewhere with www. before the apex domain, then email traffic can remain safe.</td></tr>';
	$html_text .= '<tr id="113" style="display:table-row;font-style:italic"><td colspan="2"></td><td>For a URL with a subdomain such as www, HSTS can be set more precisely.</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td colspan="3"><button style="cursor:pointer;font-size:1.05rem;font-style:italic" onclick="SwitchDisplay(34)">how to expire security.txt content +/-</button></td></tr>';
