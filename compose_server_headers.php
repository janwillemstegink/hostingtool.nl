...
$domain_server_headers->appendChild($doc->createCDATASection(htmlentities($server_headers)));		
...
$domain_server_headers_www->appendChild($doc->createCDATASection(htmlentities($server_headers_www)));		
